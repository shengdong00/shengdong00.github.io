...
如果决策变量的取值是连续的，且目标函数和约束条件都是决策变量的线性函数，则称为**线性规划问题**。
...
2. 周期态：演化方程的“终态”解 是一个以 T 为周期的周期函数 ，代表状态空间中的一条**封闭曲线**
...
1. 焦点型不动点
   ...
   <img src="/images/image-20220612004002802.png" alt="image-20220612004002802" style="zoom:67%;" />
